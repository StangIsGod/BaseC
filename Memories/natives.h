...
namespace PLAYER
{
	...
	static BOOL GET_PLAYER_TARGET_ENTITY(Player player, Entity* entity) { return invoke<BOOL>(0xF6AAA2D7, player, entity); } // 0xF6AAA2D7
	...
	static BOOL GET_PLAYER_INVINCIBLE(Player p0) { return invoke<Any>(0x680C90EE, p0); } // 0x680C90EE
	...
	static void SET_PLAYER_MAX_ARMOUR(Player Player, int Toggle) { invoke<Void>(0xC6C3C53B, Player, Toggle); } // 0xC6C3C53B
...
namespace ENTITY
{
	static void SET_ENTITY_VISIBLE2(Entity entity, BOOL toggle, BOOL unk) { invoke<Void>(0xD043E8E1, entity, toggle, unk); } // 0xD043E8E1

	static void SET_ENTITY_COLLISION5(Entity entity, BOOL toggle) { invoke<Void>(0x139FD37D, entity, toggle); } // 0x139FD37D

	static void SET_ENTITY_COORDS1(Entity entity, float X, float Y, float Z, BOOL XAxes, BOOL YAxes, BOOL ZAxes, BOOL unk) { invoke<Void>(0xDF70B41B, entity, X, Y, Z, XAxes, YAxes, ZAxes, unk); } // 0xDF70B41B
	static Vector3 _0x7C6339DF(Any p0, Any p1) { return invoke<Vector3>(0x7C6339DF, p0, p1); } // 0x7C6339DF
	static void SET_ENTITY_COORDS_TP(Entity entity, float X, float Y, float Z, BOOL XAxes, BOOL YAxes, BOOL ZAxes, BOOL unk) { invoke<Void>(0xDF70B41B, entity, X, Y, Z, XAxes, YAxes, ZAxes, unk); } // 0xDF70B41B
	static Vector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS3(Entity Entity, float xCoord, float yCoord, float zCoord) { return invoke<Vector3>(0xABCF043A, Entity, xCoord, yCoord, zCoord); } // 0xABCF043A
	static Vector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS2(Entity Entity, int xCoord, int yCoord, int zCoord) { return invoke<Vector3>(0xABCF043A, Entity, xCoord, yCoord, zCoord); } // 0xABCF043A
	static int _GET_ENTITY_BONE_INDEX(Entity entity, char* boneName) { return invoke<int>(0xE4ECAC22, entity, boneName); } // 0xFB71170B7E76ACBA 0xE4ECAC22
	...
	static BOOL HAS_ENTITY_ANIM_FINISHED(Any p0, char* p1, char* p2, Any p3) { return invoke<BOOL>(0x1D9CAB92, p0, p1, p2, p3); } // 0x1D9CAB92
	...
	static BOOL IS_ENTITY_ATTACHED_TO_ENTITY(Entity p0, Entity p1) { return invoke<BOOL>(0xB0ABFEA8, p0, p1); } // 0xB0ABFEA8
	...
	static void DELETE_ENTITY1(int* EntityHandle) { invoke<Void>(0xFAA3D236, EntityHandle); } // 0xFAA3D236

	static void DETACH_ENTITY(Any p0, Any p1, Any p2) { invoke<Void>(0xC8EFCB41, p0, p1, p2); } // 0xC8EFCB41
	static void DETACH_ENTITY1(Entity p0) { invoke<Void>(0xC8EFCB41, p0); } // 0xC8EFCB41
	...
	static void SET_ENTITY_ANIM_CURRENT_TIME(Any p0, char* p1, char* p2, float p3) { invoke<Void>(0x99D90735, p0, p1, p2, p3); } // 0x99D90735
	static void SET_ENTITY_ANIM_SPEED(Any p0, char* p1, char* p2, float p3) { invoke<Void>(0x3990C90A, p0, p1, p2, p3); } // 0x3990C90A
	...
	static void SET_ENTITY_MAX_SPEED(Any p0, float p1) { invoke<Void>(0x46AFFED3, p0, p1); } // 0x46AFFED3
	...
	static void SET_ENTITY_ALPHA(Entity entity, int AlphaLVL, bool skin) { invoke<Void>(0xAE667CB0, entity, AlphaLVL, skin); } // 0xAE667CB0
	...
	static void CREATE_MODEL_HIDE(float p0, float p1, float p2, float p3, Hash p4, BOOL p5) { invoke<Void>(0x7BD5CF2F, p0, p1, p2, p3, p4, p5); } // 0x7BD5CF2F
	static void _0x07AAF22C(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x07AAF22C, p0, p1, p2, p3, p4, p5); } // 0x07AAF22C
	static void REMOVE_MODEL_HIDE(float p0, float p1, float p2, float p3, Hash p4, BOOL p5) { invoke<Void>(0x993DBC10, p0, p1, p2, p3, p4, p5); } // 0x993DBC10
...
namespace PED
{
	...
	static void DELETE_PED1(Ped1* ped) { invoke<Void>(0x13EFB9A0, ped); } // 0x13EFB9A0
	...
	static BOOL IS_PED_IN_ANY_HELI(Ped p0) { return invoke<BOOL>(0x7AB5523B, p0); } // 0x7AB5523B
	static BOOL IS_PED_IN_ANY_PLANE(Any p0) { return invoke<BOOL>(0x51BBCE7E, p0); } // 0x51BBCE7E
	static BOOL IS_PED_IN_FLYING_VEHICLE(Ped p0) { return invoke<BOOL>(0xCA072485, p0); } // 0xCA072485
	...
	static int GET_PED_MAX_HEALTH(Any p0) { return invoke<int>(0xA45B6C8D, p0); } // 0xA45B6C8D
	...
	static void SET_PED_STRAFE_CLIPSET(Any p0, char* p1) { invoke<Void>(0x0BACF010, p0, p1); } // 0x0BACF010
	...
	static int GET_PED_PROP_INDEX(Ped PedHandle, int ComponentID) { return invoke<int>(0x746DDAC0, PedHandle, ComponentID); } // 0x746DDAC0
	...
	static Ped GET_CLOSEST_PED(float x, float y, float z, float Radius, BOOL p4, BOOL p5, uint32_t* handle, BOOL p7, BOOL p8, int p9) { return invoke<Ped>(0x8F6C1F55, x, y, z, Radius, p4, p5, handle, p7, p8, p9); } // 0x8F6C1F55
	...
	static void SET_SYNCHRONIZED_SCENE_RATE(Any p0, float p1) { invoke<Void>(0xF10112FD, p0, p1); } // 0xF10112FD
	...
	static int REGISTER_PEDHEADSHOT(Ped ped) { return invoke<int>(0xFFE2667B, ped); } // 0xFFE2667B	static Any _0x4DD03628(Any p0) { return invoke<Any>(0x4DD03628, p0); } // 0x4DD03628
	...
	static char *GET_PEDHEADSHOT_TXD_STRING(int handle) { return invoke<char*>(0x76D28E96, handle); } // 0x76D28E96	static void SET_PEDHEADSHOT_CUSTOM_LIGHTING(Any p0) { invoke<Void>(0xAB688DAB, p0); } // 0xAB688DAB
...
namespace VEHICLE
{
	...
	static BOOL ARE_ANY_VEHICLE_SEATS_FREE(Vehicle p0) { return invoke<Any>(0x648E685A, p0); } // 0x648E685A
	...
	static void _0x920C2517(Entity p0, float p1) { invoke<Void>(0x920C2517, p0, p1); } // 0x920C2517
...
namespace OBJECT
{
	...
	static Object _GET_CLOSEST_OBJECT_OF_TYPE(float x, float y, float z, float p3, Hash type, BOOL p5, BOOL p6, BOOL p7) { return invoke<Object>(0x45619B33, x, y, z, p3, type, p5, p6, p7); } // 0x45619B33
	...
	static void _0x43BB7E48(Hash p0, BOOL p1) { invoke<Void>(0x43BB7E48, p0, p1); } // 0x43BB7E48
...
namespace AI
{
	...
	static void SET_PARACHUTE_TASK_THRUST(Ped p0, float p1) { invoke<Void>(0xD07C8AAA, p0, p1); } // 0xD07C8AAA
	...
	static void SET_ANIM_RATE(Any p0, float p1, Any p2, BOOL p3) { invoke<Void>(0x6DB46584, p0, p1, p2, p3); } // 0x6DB46584
	...
	static void TASK_AIM_GUN_SCRIPTED(Ped p0, Hash p1, Any p2, Any p3) { invoke<Void>(0x9D296BCD, p0, p1, p2, p3); } // 0x9D296BCD
	...
	static void TASK_PLANE_MISSION(Ped pilot, Vehicle aircraft, Vehicle targetVehicle, Ped targetPed, float destinationX, float destinationY, float destinationZ, int missionFlag, float angularDrag, float unk, float targetHeading, float maxZ, float minZ) { invoke<Void>(0x1D007E65, pilot, aircraft, targetVehicle, targetPed, destinationX, destinationY, destinationZ, missionFlag, angularDrag, unk, targetHeading, maxZ, minZ); } // 0x1D007E65
...
namespace GAMEPLAY
{
	static int _GET_FRAME_COUNT() { return invoke<int>(0xB477A015); } // 0xB477A015
	...
	static int GET_FRAME_TIME() { return invoke<float>(0x96374262); } // 0x96374262
	static int GET_FRAME_COUNT() { return invoke<float>(0xB477A015); } // 0xB477A015
	...
	static float GET_DISTANCE_BETWEEN_COORDS(float x1, float y1, float z1, float x2, float y2, float z2, BOOL useZ) { return invoke<float>(0xF698765E, x1, y1, z1, x2, y2, z2, useZ); } // 0xF698765E
	...
	static int GET_HASH_KEY1(int ToHash) { return invoke<int>(0x98EFF6F1, ToHash); } // 0x98EFF6F1
	...
	static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS_1(float StartPositionX, float StartPositionY, float StartPositionZ, float HitPositionX, float HitPositionY, float HitPositionZ, Any p6, Any p7, Hash WeaponHash, Ped PedHandle, Any p10, Any p11, float Speed) { invoke<Void>(0xCB7415AC, StartPositionX, StartPositionY, StartPositionZ, HitPositionX, HitPositionY, HitPositionZ, p6, p7, WeaponHash, PedHandle, p10, p11, Speed); } // 0xCB7415AC
...
namespace INTERIOR
{
	static void _HIDE_MAP_OBJECT_THIS_FRAME(Hash mapObjectHash) { invoke<Void>(0x1F375B4C, mapObjectHash); } // 0x1F375B4C
...
namespace CAM
{
	static void SET_CAM_ROT_V2(int p0, float p1, float p2, float p3) { invoke<Void>(0xEE38B3C1, p0, p1, p2, p3); } // 0xEE38B3C1
	static void SET_CAM_ACTIVE1(Any cam, BOOL active) { invoke<Void>(0x064659C2, cam, active); } // 0x064659C2
	static void RENDER_SCRIPT_CAMS1(BOOL render, BOOL ease, Any camera, BOOL p3, BOOL p4) { invoke<Void>(0x74337969, render, ease, camera, p3, p4); } // 0x74337969
	static Cam CREATE_CAMERA1(Hash camName, BOOL p1) { return invoke<Cam>(0x5D6739AE, camName, p1); } // 0x5D6739AE
	static void DESTROY_CAM1(Cam cam, BOOL destroy) { invoke<Void>(0xC39302BD, cam, destroy); } // 0xC39302BD
	static void ATTACH_CAM_TO_PED_BONE1(int cam, Ped ped, int boneIndex, float x, float y, float z, BOOL heading) { invoke<Void>(0x506BB35C, cam, ped, boneIndex, x, y, z, heading); } // 0x506BB35C
	static void RENDER_SCRIPT_CAMS(BOOL p0, BOOL p1, int p2, BOOL p3, BOOL p4) { invoke<Void>(0x74337969, p0, p1, p2, p3, p4); } // 0x74337969
	static void _0xD3C08183(Any p0, Any p1, Any p2) { invoke<Void>(0xD3C08183, p0, p1, p2); } // 0xD3C08183
	static Any CREATE_CAM(char* camName, BOOL p1) { return invoke<Any>(0xE9BF2A7D, camName, p1); } // 0xE9BF2A7D
	...
	static void DESTROY_CAM(Cam p0, BOOL p1) { invoke<Void>(0xC39302BD, p0, p1); } // 0xC39302BD
	static void DESTROY_ALL_CAMS(Any p0) { invoke<Void>(0x10C151CE, p0); } // 0x10C151CE
	static BOOL DOES_CAM_EXIST(Cam p0) { return invoke<BOOL>(0x1EF89DC0, p0); } // 0x1EF89DC0
	static void SET_CAM_ACTIVE(Cam cam, BOOL active) { invoke<Void>(0x064659C2, cam, active); } // 0x064659C2
	...
	static void SET_CAM_COORD(Cam cam, float posX, float posY, float posZ) { invoke<Void>(0x7A8053AF, cam, posX, posY, posZ); } // 0x7A8053AF
	static void SET_CAM_ROT(Any p0, Vector3 p1, Any p2) { invoke<Void>(0xEE38B3C1, p0, p1, p2); } // 0xEE38B3C1
	static void SET_CAM_ROT1(Cam cam, float rotX, float rotY, float rotZ, int p4) { invoke<Void>(0xEE38B3C1, cam, rotX, rotY, rotZ, p4); } // 0xEE38B3C1
	static void SET_CAM_FOV(Cam cam, float fieldOfView) { invoke<Void>(0xD3D5D74F, cam, fieldOfView); } // 0xD3D5D74F
	...
	static void ATTACH_CAM_TO_ENTITY(Cam cam, Entity entity, float xOffset, float yOffset, float zOffset, BOOL isRelative) { invoke<Void>(0xAD7C45F6, cam, entity, xOffset, yOffset, zOffset, isRelative); } // 0xAD7C45F6
	...
	static void POINT_CAM_AT_COORD(Cam p0, float p1, float p2, float p3) { invoke<Void>(0x914BC21A, p0, p1, p2, p3); } // 0x914BC21A
	...
	static void STOP_CAM_POINTING(int p0) { invoke<Void>(0x5435F6A5, p0); } // 0x5435F6A5
...
namespace WEAPON
{
	...
	static Hash GET_WEAPON_COMPONENT_TYPE_MODEL(Hash p0) { return invoke<Any>(0x324FA47A, p0); } // 0x324FA47A
	static Hash GET_WEAPONTYPE_MODEL(Hash p0) { return invoke<Hash>(0x44E1C269, p0); } // 0x44E1C269
	...
	static Any GET_AMMO_IN_CLIP(Ped Handle, Hash WeaponHash, int* p2) { return invoke<Any>(0x73C100C3, Handle, WeaponHash, p2); } // 0x73C100C3
	static Any GET_AMMO_IN_CLIP2(Ped Handle, Hash WeaponHash, int p2) { return invoke<Any>(0x73C100C3, Handle, WeaponHash, p2); } // 0x73C100C3
	...
	static Any GET_PED_AMMO_TYPE_FROM_WEAPON(Ped p0, Hash p1) { return invoke<Any>(0x09337863, p0, p1); } // 0x09337863
	...
	static BOOL GET_PED_LAST_WEAPON_IMPACT_COORD_A(Ped Handle, float* Coords) { return invoke_a<BOOL>(0x9B266079, Handle, Coords); } // 0x9B266079
	...
	static int GET_WEAPON_TINT_COUNT(Hash p0) { return invoke<Any>(0x99E4EAAB, p0); } // 0x99E4EAAB
...
namespace STREAMING
{
	...
	static void REQUEST_ANIM_SET2(char* animSet) { invoke<Void>(0x2988B3FC, animSet); } // 0x2988B3FC 0x2988B3FC
	static BOOL HAS_ANIM_SET_LOADED2(char* animSet) { return invoke<BOOL>(0x4FFF397D, animSet); } // 0x4FFF397D 0x4FFF397D
	...
	static BOOL IS_MODEL_VALID(Hash p0) { return invoke<BOOL>(0xAF8F8E9D, p0); } // 0xAF8F8E9D
	...
	static void REMOVE_ANIM_DICT(char* p0) { invoke<Void>(0x0AE050B5, p0); } // 0x0AE050B5
	static void REQUEST_ANIM_SET(char* p0) { invoke<Void>(0x2988B3FC, p0); } // 0x2988B3FC
	static BOOL HAS_ANIM_SET_LOADED(char* p0) { return invoke<BOOL>(0x4FFF397D, p0); } // 0x4FFF397D
...
namespace UI
{
	...
	static void ADD_TEXT_COMPONENT_SUBSTRING_TIME(char *p0, int p1) { invoke<Void>(0x135B3CD0, p0, p1); } // 0x135B3CD0
	...
	static char* GET_STREET_NAME_FROM_HASH_KEY(Any p0) { return invoke<char*>(0x1E8E310C, p0); } // 0x1E8E310C
...
namespace GRAPHICS
{
	...
	static void _START_SCREEN_EFFECT(char *effectName, int duration, BOOL looped) { invoke<Void>(0x1D980479, effectName, duration, looped); }// 0x2206BF9A37B7F724 0x1D980479
	static void DRAW_SCALEFORM_MOVIE11(int handle, float x, float y, float width, float height, int red, int green, int blue, int alpha, int p9) { invoke<Void>(0x48DA6A58, handle, x, y, width, height, red, green, blue, alpha, p9); } // 0x48DA6A58
	static void POP_SCALEFORM_MOVIE_FUNCTION_VOID() { invoke<Void>(0x02DBF2D7); } // 0x02DBF2D7
	static void SET_PARTICLE_FX_NON_LOOPED_COLOUR(float r, float g, float b) { invoke<Void>(0x7B689E20, r, g, b); } // 0x7B689E20
	static BOOL _START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2(char *effectName, Ped ped, float xOffset, float yOffset, float zOffset, float xRot, float yRot, float zRot, int boneIndex, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<BOOL>(0x161780C1, effectName, ped, xOffset, yOffset, zOffset, xRot, yRot, zRot, boneIndex, scale, xAxis, yAxis, zAxis); } // 0x161780C1From:kawasakibalius2
	static BOOL _START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_3(char* p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, BOOL p8, BOOL p9, BOOL p10) { return invoke<Any>(0x161780C1, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x161780C1

	static void _SET_PTFX_ASSET_NEXT_CALL(char* p0) { invoke<Void>(0x9C720B61, p0); } // 0x9C720B61From:kawasakibalius2
	static BOOL HAS_SCALEFORM_MOVIE_LOADED2(int scaleform) { return invoke<BOOL>(0xDDFB6448, scaleform); } // 0xDDFB6448
	static void DRAW_SCALEFORM_MOVIE3(int handle, float x, float y, float width, float height, int r, int g, int b, int a) { invoke<Void>(0x48DA6A58, handle, x, y, width, height, r, g, b, a); } // 0x48DA6A58
	...
	static void _DRAW_RECT(float* xyz1, float* xyz2, int r, int g, int b, int a) { invoke<Void>(0xDD2BFC77, xyz1, xyz2, r, g, b, a); } // 0xDD2BFC77
	static void _DRAW_SCALEFORM_MOVIE(int handle, float LEFTxRIGHT, float UPyDOWN, float width, float height, int red, int green, int blue, int alpha, int p9) { invoke<Void>(0x48DA6A58, handle, LEFTxRIGHT, UPyDOWN, width, height, red, green, blue, alpha, p9); } // 0x48DA6A58
	...
	static void DRAW_BOX(float p0, float p1, float p2, float p3, float p4, float p5, int p6, int p7, int p8, int p9) { invoke<Void>(0xCD4D9DD5, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0xCD4D9DD5
	...
	static void _SET_BLACKOUT(BOOL enable) { invoke<Void>(0xAA2A0EAF, enable); } // 0xAA2A0EAF
	...
	static void SET_PARTICLE_FX_LOOPED_EVOLUTION(int ptfxHandle, char *propertyName, float amount, BOOL Id) { invoke<Void>(0x1CBC1373, ptfxHandle, propertyName, amount, Id); } // 0x1CBC1373
	static void SET_PARTICLE_FX_LOOPED_COLOUR(int ptfxHandle, float r, float g, float b, BOOL p4) { invoke<Void>(0x5219D530, ptfxHandle, r, g, b, p4); } // 0x5219D530
	...
	static Any _0x7CC8057D(char* p0) { return invoke<Any>(0x7CC8057D, p0); } // 0x7CC8057D
	...
	static void DRAW_SCALEFORM_MOVIE(int scaleformHandle, float x, float y,float width, float height, int red, int green, int blue,int alpha, int unk) { invoke<Void>(0x48DA6A58,  scaleformHandle,  x,  y,  width,  height,  red,  green,  blue,  alpha,  unk); } // 0x48DA6A58
...
namespace PATHFIND
{
	...
	static void GET_STREET_NAME_AT_COORD(float p0, float p1, float p2, Hash *p3, Hash *p4) { invoke<Void>(0xDEBEEFCF, p0, p1, p2, p3, p4); } // 0xDEBEEFCF
...
namespace ZONE
{
	...
	static void OVERRIDE_POPSCHEDULE_VEHICLE_MODEL(Any p0, Any p1) { invoke<Void>(0x3F0A3680, p0, p1); } // 0x3F0A3680
...
namespace ROPE
{
	...
	static void ROPE_DRAW_SHADOW_ENABLED(Object* p0, bool p1) { invoke<Void>(0x51523B8C, p0, p1); } // 0x51523B8C
	...
	static void _0x5187BED3(Object p0) { invoke<Void>(0x5187BED3, p0); } // 0x5187BED3
	static void _0x46826B53(Any p0) { invoke<Void>(0x46826B53, p0); } // 0x46826B53
	static void _0xFC0DB4C3(Object p0) { invoke<Void>(0xFC0DB4C3, p0); } // 0xFC0DB4C3
	...
	static bool _0x5FDC1047() { return invoke<bool>(0x5FDC1047); } // 0x5FDC1047
...
namespace WATER
{
	...
	static void MODIFY_WATER(float x, float y, float radius, float height) { invoke<Void>(0xC49E005A, x, y, radius, height); } // 0xC49E005A
}
...
namespace WORLDPROBE
{
	...
	static Any _0x8251485D(Vector3* Start, Vector3* End, int flag, int entity, int unk) { return invoke<Any>(0x8251485D, Start, End, flag, entity, unk); } // 0x8251485D
	...
	static Any _0xF3C2875A(int handle, int* hit, Vector3* hitCoords, Vector3* surfaceCoords, int* entity) { return invoke<Any>(0xF3C2875A, handle, hit, hitCoords, surfaceCoords, entity); } // 0xF3C2875A
...
namespace NETWORK
{
	...
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE7771(Entity entity, float p2, float p3, float p4, int netScene, char *animDict, char *animName, float speed, float speedMultiplier, int duration, int flag, float playbackRate) { invoke<Void>(0xB386713E, entity, p2, p3, p4, netScene, animDict, animName, speed, speedMultiplier, duration, flag, playbackRate); } // 0xB386713E
	static int NETWORK_CREATE_SYNCHRONISED_SCENE777(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<int>(0xB06FE3FE, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11); } // 0xB06FE3FE
	static int NETWORK_CREATE_SYNCHRONISED_SCENE777ll(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9) { return invoke<int>(0xB06FE3FE, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9); } // 0xB06FE3FE
	static int NETWORK_CREATE_SYNCHRONISED_SCENE_3(float x, float y, float z, float xrot, float yrot, float zrot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<int>(0xB06FE3FE, x, y, z, xrot, yrot, zrot, p6, p7, p8, p9, p10, p11); } // 0xB06FE3FE
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE_3(Ped player, int scene, char* anim, char* animid, float speed, float speedmul, int duration, int flag, float playbackr, Any p9) { invoke<Void>(0xB386713E, player, scene, anim, animid, speed, speedmul, duration, flag, playbackr, p9); }
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE_4(Ped player, int scene, char* anim, char* animid, float speed, float speedmul, int duration, int flag, float playbackr, Any p9) { invoke<Void>(0xB386713E, player, scene, anim, animid, speed, speedmul, duration, flag, playbackr, p9); } // 0xB386713E
	...
	static Any NETWORK_HOST_TEST() { return invoke<Any>(0x12F6D7C); } // 0xE46AC10F A8B814
	...
	static void _NETWORK_SESSION_HOSTED(BOOL p0) { invoke<Void>(0xF3768F90, p0); } // 0xF3768F90
	...
	static void NETWORK_DO_TRANSITION_TO_FREEMODE(int p0, int p1, BOOL p2, int p3) { invoke<Void>(0xC7CB8ADF, p0, p1, p2, p3); } // 0xC7CB8ADF
	static BOOL NETWORK_DO_TRANSITION_TO_NEW_FREEMODE(int *networkHandle, Any *p1,int players, BOOL p3, BOOL p4, BOOL p5) { return invoke<Any>(0xAD13375E, networkHandle, p1, players, p3, p4); } // 0xAD13375E
	...
	static Player _0x40DBF464(Ped p0) { return invoke<Any>(0x40DBF464, p0); } // 0x40DBF464
	...
	static Any NETWORK_GET_HOST_OF_SCRIPT(char* p0, Any p1, Any p2) { return invoke<Any>(0x9C95D0BB, p0, p1, p2); } // 0x9C95D0BB
	...
	static int NETWORK_GET_NETWORK_ID_FROM_ENTITY(Entity p0) { return invoke<Any>(0x9E35DAB6, p0); } // 0x9E35DAB6
	...
	static Ped NET_TO_PED(int p0) { return invoke<Any>(0x87717DD4, p0); } // 0x87717DD4
	...
	static void NETWORK_HANDLE_FROM_PLAYER_1(Ped PedHandle, int *FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); } // 0xD3498917
	...
	static char* _0x4EC0D983(Any p0, char* p1) { return invoke<char*>(0x4EC0D983, p0, p1); } // 0x4EC0D983
	static BOOL NETWORK_PLAYER_IS_ROCKSTAR_DEV(Player player) { return invoke<BOOL>(0xF6659045, player); } // 0xF6659045
	static BOOL _0xD265B049(Player p0) { return invoke<Player>(0xD265B049, p0); } // 0xD265B049
	...
	static BOOL NETWORK_IS_FRIEND_ONLINE(char *name) { return invoke<BOOL>(0xE0A42430, name); } // 0xE0A42430
	...
	static BOOL NETWORK_IS_FRIEND(int *networkHandle) { return invoke<BOOL>(0x2DA4C282, networkHandle); } // 0x2DA4C282
	...
	static Any NETWORK_ADD_FRIEND(Any p0, char* p1) { return invoke<Any>(0x20E5B3EE, p0, p1); } // 0x20E5B3EE
	...
	static BOOL NETWORK_IS_PLAYER_IN_MP_CUTSCENE(Player player) { return invoke<BOOL>(0x56F961E4, player); } // 0x56F961E4 check if is in cutscene
	...
	static void NETWORK_ADD_ENTITY_TO_SYNCHRONISED_SCENE(Any p0, Any p1, char* p2, char* p3, Any p4, Any p5, Any p6) { invoke<Void>(0x10DD636C, p0, p1, p2, p3, p4, p5, p6); } // 0x10DD636C
...
namespace DECORATOR
{
	static BOOL DECOR_SET_TIME(Entity p0, char* p1, int p2) { return invoke<Any>(0xBBAEEF94, p0, p1, p2); } // 0xBBAEEF94
	static BOOL DECOR_SET_BOOL(Entity p0, char *p1, BOOL p2) { return invoke<Any>(0x8E101F5C, p0, p1, p2); } // 0x8E101F5C
	static BOOL DECOR_SET_INT(Entity p0, char* p1, int p2) { return invoke<Any>(0xDB718B21, p0, p1, p2); } // 0xDB718B21
	static BOOL DECOR_GET_BOOL(Entity p0, char* p1) { return invoke<Any>(0xDBCE51E0, p0, p1); } // 0xDBCE51E0
	static int DECOR_GET_INT(Entity p0, char *p1) { return invoke<Any>(0xDDDE59B5, p0, p1); } // 0xDDDE59B5
	static BOOL DECOR_EXIST_ON(Entity p0, char *p1) { return invoke<Any>(0x74EF9C40, p0, p1); } // 0x74EF9C40
	static BOOL DECOR_REMOVE(Entity p0, char *p1) { return invoke<Any>(0xE0E2640B, p0, p1); } // 0xE0E2640B
	static void DECOR_REGISTER(char* p0, int p1) { invoke<Void>(0x68BD42A9, p0, p1); } // 0x68BD42A9
	static BOOL DECOR_IS_REGISTERED_AS_TYPE(char *p0, int p1) { return invoke<Any>(0x7CF0971D, p0, p1); } // 0x7CF0971D
